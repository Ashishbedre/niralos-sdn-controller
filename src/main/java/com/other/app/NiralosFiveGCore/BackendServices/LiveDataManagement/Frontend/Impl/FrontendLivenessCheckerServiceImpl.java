...
public class FrontendLivenessCheckerServiceImpl implements FrontendLivenessCheckerService{
	private static final Logger loggerTypeB = LoggerFactory.getLogger("5G-FRONTEND:FrontendLivenessCheckerServiceImpl");
	...
	public void deploymentActiveChecker() {
		loggerTypeB.info("deploymentActiveChecker: Starting deployment active checker.");
		// Retrieve all deployment models from the repository
	...
	public void subZoneActiveChecker() {
		loggerTypeB.info("subZoneActiveChecker: Starting sub-zone active checker.");
		// Retrieve all sub-zone models from the repository
	...
	public void zoneActiveChecker() {
		loggerTypeB.info("zoneActiveChecker: Starting zone active checker.");
		// Retrieve all zone models from the repository
