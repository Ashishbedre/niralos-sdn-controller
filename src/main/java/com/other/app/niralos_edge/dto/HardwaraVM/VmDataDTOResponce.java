...
public class VmDataDTOResponce {
...
//    private String digest;
    ...
    // Additional fields for categorized arrays
    private List<Map<String, String>> network = new ArrayList<>();
...
//    }
    ...
    public void setNetwork(List<Map<String, String>> network) {
        this.network = network;
    }

    public List<Map<String, String>> getCdAndDvd() {
        return cdAndDvd;
    }

    public void setCdAndDvd(List<Map<String, String>> cdAndDvd) {
        this.cdAndDvd = cdAndDvd;
    }

    public List<Map<String, String>> getHarddisk() {
        return harddisk;
    }
