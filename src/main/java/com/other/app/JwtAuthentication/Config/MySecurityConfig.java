...
//		.antMatchers("/v3/api-docs/**").permitAll()
		...
		.antMatchers("/v2/alarm_manager/**").hasRole("NORMAL")
		.antMatchers("/v2/5gcore/**").hasRole("NORMAL")
		.antMatchers("/v2/5gcore/**").hasRole("NORMAL")
		.antMatchers("/v2/log_manager/**").hasRole("NORMAL")
		.antMatchers("/v2/5gcore/subscriber/**").hasRole("NORMAL")
		.antMatchers("/v2/5gcore/**").hasRole("NORMAL")
		.antMatchers("/v2/5gcoredeployment/**").hasRole("NORMAL")
//				.antMatchers("/v2/nef/**").hasRole("NORMAL")
