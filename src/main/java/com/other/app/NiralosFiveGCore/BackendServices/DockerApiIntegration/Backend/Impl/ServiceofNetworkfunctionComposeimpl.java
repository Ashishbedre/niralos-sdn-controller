...
public class ServiceofNetworkfunctionComposeimpl extends Thread implements ServiceofNetworkfunctionCompose {
	...
	private static final Logger loggerTypeA = LoggerFactory.getLogger("5G-BACKEND:ServiceofNetworkfunctionComposeimpl");
	...
	public void niralosNrf() {
		...
		try {
			...
			loggerTypeA.info("Waiting for pulling the Nrf Image");
			...
			synchronized (lock) {
				try {
					...
					loggerTypeA.error("Error during container creation or restart");
				}
			}

		} catch (Exception e) {
			loggerTypeA.error("Error in niralosNrf method");
		}
	...
	public void niralosScp() {
		...
		try {
			...
			loggerTypeA.info("Waiting for pulling the Scp Image");
			...
			synchronized (lock) {
				try {
					...
					loggerTypeA.error("niralosScp: Error during container creation or restart");
				}
			}

		} catch (Exception e) {
			loggerTypeA.error("niralosScp: Error in niralosScp method");
		}
	...
	public void niralosUdr() {
		...
		try {
			...
			loggerTypeA.info("Waiting for condition complete");
			...
			synchronized (lock) {
				try {
					...
					loggerTypeA.info("Image container complete");
					String containerId = dockerContainerResponse.getId();
					if (containerId != null) {
						String startEndpoint = "/v1.43/containers/" + dockerContainerResponse.getId() + "/restart";
						this.restartContainer(startEndpoint);
					...
					loggerTypeA.error("niralosUdr: Error during container creation or restart");
				}
			}

		} catch (Exception e) {
			loggerTypeA.error("niralosUdr: Error in niralosScp method");
		}
	}
	...
	public void niralosUdm() {
		...
		try {
			...
			loggerTypeA.info("Waiting for pulling the Udm Image");
			...
			synchronized (lock) {
				try {
					...
					loggerTypeA.error("niralosUdm: Error during container creation or restart");
				}
			}
		} catch (Exception e) {
			loggerTypeA.error("niralosUdm: Error in niralosScp method");
		}
	...
	public void niralosAusf() {
		...
		try {
			...
			loggerTypeA.info("Waiting for pulling the Ausf Image");
			...
			synchronized (lock) {
				try {
					...
					loggerTypeA.error("niralosAusf: Error during container creation or restart");

				}
			}

		} catch (Exception e) {
			loggerTypeA.error("niralosAusf: Error in niralosAusf method");
		}
	}
	...
	public void niralosPcf() {
		...
		try {
			...
			loggerTypeA.info("Waiting for pulling the pcf Image");
			...
			synchronized (lock) {
				try {
					...
					loggerTypeA.error("niralosPcf: Error during container creation or restart");
				}
			}

		} catch (Exception e) {
			loggerTypeA.error("niralosPcf: Error in niralosPcf method");
		}
	...
	public void niralosBsf() {
		...
		try {
			...
			loggerTypeA.info("Waiting for pulling the Bsf Image");
			...
			synchronized (lock) {
				try {
					...
					loggerTypeA.error("niralosBsf: Error during container creation or restart");
				}
			}

		} catch (Exception e) {
			loggerTypeA.error("niralosBsf: Error in niralosBsf method");
		}
	...
	public void niralosNssf() {
		...
		try {
			...
			loggerTypeA.info("Waiting for pulling the Nssf Image");
			...
			synchronized (lock) {
				try {
					...
					loggerTypeA.error("niralosNssf: Error during container creation or restart");
				}
			}

		} catch (Exception e) {
			loggerTypeA.error("niralosNssf: Error in niralosNssf method");
		}
	...
	public void niralosAmf() {
		...
		try {
			...
			loggerTypeA.info("Waiting for pulling the Amf Image");
...
//				 String startUrl = dockerApiUrl + startEndpoint;
					...
					loggerTypeA.error("niralosAmf: Error during container creation or restart");
				}
			}

		} catch (Exception e) {
			loggerTypeA.error("niralosAmf: Error in niralosAmf method");
		}
		try {
			Thread.sleep(10000);
...
//				 String startUrl = dockerApiUrl + startEndpoint;
					...
					loggerTypeA.error("niralosSmf: Error during container creation or restart");
				}
			}

		} catch (Exception e) {
			loggerTypeA.error("niralosSmf: Error in niralosSmf method");
		}
		...
		try {
			...
			synchronized (lock) {
				try {
					...
					loggerTypeA.error("niralosUpf: Error during container creation or restart");
				}
			}

		} catch (Exception e) {
			loggerTypeA.error("niralosUpf: Error in niralosUpf method");
		}
		...
		if (startResponseBody != null) {
			for (HashMap<String, Object> containerInfo : startResponseBody) {
				...
				if (hashMap.equals(Data1[0])) {
					...
					loggerTypeA.info("niralosDeletionofContainer: Container stopped successfully: " + containerInfo.get("Id"));

					this.Webclient().delete().uri("/v1.43/containers/" + containerInfo.get("Id")).retrieve().toBodilessEntity()
							.block();

					loggerTypeA.info("niralosDeletionofContainer: Container removed successfully: " + containerInfo.get("Id"));
				}
...
//				String  list[] = ["niralos-amf","niralos-upf"]
				if(Data1[0].equals(containerName)){
					loggerTypeA.info("ContainerId : " + container.get("Id") + "Container: " +Data1[0] + "Image : " + container.get("Image"));
		...
		{
			loggerTypeA.error("addTheMacvlanNetwork: Null");
		}
	}
	...
	public void restartContainer(String startEndpoint) {
		...
		.subscribe(startResponseBody -> {
			loggerTypeA.info("Container start response: " + startResponseBody);
		}, throwable -> {
			if (throwable instanceof WebClientResponseException) {
				WebClientResponseException responseException = (WebClientResponseException) throwable;
				loggerTypeA.info("Error response body: " + responseException.getResponseBodyAsString());
			}
			loggerTypeA.info("restartContainer: Error: " + throwable.getMessage());
		});
	}
	...
	public void pullImageWebclient(String endpoint) {
		...
		.doOnSubscribe(
				subscription -> loggerTypeA.info("Image pull for '" + this.GlobalImage() + "' in progress..."))
		.doOnTerminate(() -> {
			loggerTypeA.info("pullImageWebclient: Image pull complete.");
			synchronized (lock) {
			...
			loggerTypeA.info("pullImageWebclient: Error: " + throwable.getMessage());
		});
	...
	public void pullImageofMongo() {
	  ...
	  synchronized (ti) {
          ...
          this.Webclient().post().uri(endpoint)
                  ...
                  .doOnSubscribe(subscription -> loggerTypeA.info("Image pull for '" + imageName + "' in progress..."))
                  .doOnTerminate(() -> {
                	  loggerTypeA.info("Image pull complete.");
                      synchronized (lock) {
                          lock.notify(); // Notify the waiting thread (ti2)
                      }
                  })
                  .subscribe(responseBody -> {
                	  ...
                	  loggerTypeA.info("Error: " + throwable.getMessage());
                  });
      }
...
//      requestBodyMap.put("Env", new String[]{"MONGO_INITDB_ROOT_USERNAME=admin", "MONGO_INITDB_ROOT_PASSWORD=adminpass"});
      ...
      .doOnSuccess(response -> loggerTypeA.info("Container created: " + response))
      .block(); // blocking for simplicity, consider using subscribe() in a real application
		...
		if (containerId != null) {
		 ...
		 .subscribe(startResponseBody -> {
		     ...
		     if (throwable instanceof WebClientResponseException) {
		         WebClientResponseException responseException = (WebClientResponseException) throwable;
		         loggerTypeA.error("Error response body: " + responseException.getResponseBodyAsString());
		     }
		     loggerTypeA.error("Error: " + throwable.getMessage());
		 });
		}
        } catch (InterruptedException e) {
//            e.printStackTrace();
	...
	public void niralosDeletionofUpfContainer() {
		...
		if (startResponseBody != null) {
			for (HashMap<String, Object> containerInfo : startResponseBody) {
				// Access data in the HashMap as needed
				loggerTypeA.info("ContainerId : " + containerInfo.get("Id") + "Image: " +containerInfo.get("Image") + "Names : " + containerInfo.get("Names"));
				...
				if ("niralos-upf-1".equals(Data1[0])) {
					...
					loggerTypeA.info("niralosDeletionofUpfContainer: Container stopped successfully " + containerInfo.get("Id"));

					this.Webclient().delete().uri("/v1.43/containers/" + containerInfo.get("Id")).retrieve().toBodilessEntity()
							.block();

					loggerTypeA.info("niralosDeletionofUpfContainer: Container removed successfully " + containerInfo.get("Id"));
				}
		...
		if (startResponseBody != null) {
			for (HashMap<String, Object> containerInfo : startResponseBody) {
				...
				if ("niralos-amf-1".equals(Data1[0])) {
					...
					loggerTypeA.info("niralosDeletionofAmfContainer: Container stopped successfully " + containerInfo.get("Id"));

					this.Webclient().delete().uri("/v1.43/containers/" + containerInfo.get("Id")).retrieve().toBodilessEntity()
							.block();

					loggerTypeA.info("niralosDeletionofAmfContainer: Container removed successfully " + containerInfo.get("Id"));
				}
		...
		if (startResponseBody != null) {
			for (HashMap<String, Object> containerInfo : startResponseBody) {
				...
				if ("niralos-smf-1".equals(Data1[0])) {
					...
					loggerTypeA.info("niralosDeletionofSmfContainer: Container stopped successfully  " + containerInfo.get("Id"));

					this.Webclient().delete().uri("/v1.43/containers/" + containerInfo.get("Id")).retrieve().toBodilessEntity()
							.block();

					loggerTypeA.info("niralosDeletionofSmfContainer: Container removed successfully " + containerInfo.get("Id"));
				}
		...
		if (startResponseBody != null) {
			for (HashMap<String, Object> containerInfo : startResponseBody) {
				...
				if ("niralos-nssf-1".equals(Data1[0])) {
					...
					loggerTypeA.info("niralosDeletionofNssfContainer: Container stopped successfully " + containerInfo.get("Id"));

					this.Webclient().delete().uri("/v1.43/containers/" + containerInfo.get("Id")).retrieve().toBodilessEntity()
							.block();

					loggerTypeA.info("niralosDeletionofNssfContainer: Container removed successfully " + containerInfo.get("Id"));
				}
