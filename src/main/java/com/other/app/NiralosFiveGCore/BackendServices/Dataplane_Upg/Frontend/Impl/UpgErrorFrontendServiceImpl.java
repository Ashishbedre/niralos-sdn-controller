...
public class UpgErrorFrontendServiceImpl implements UpgErrorFrontendService{
	private static final Logger loggerTypeB = LoggerFactory.getLogger("5G-FRONTEND:UpgErrorFrontendServiceImpl");
	...
	public List<UpgErrorModel> getUpgErrorData() {
		loggerTypeB.info("getUpgErrorData: Retrieving all UPG error data.");
	...
	public List<UpfErrorGraphDto> getUpfErrorByFilter(String type, String reason) {
		loggerTypeB.info("getUpfErrorByFilter: Fetching UPF error data by type");
	...
	public UpgUpfRoot getCombinedErrorByFilter(String type) {
		...
		try {
			...
			loggerTypeB.error("getCombinedErrorByFilter: Upg List is have null value. Exception");
		}
		try {
		upfErrorModels=    upfErrorModelRepository.findAll();
		}catch (Exception e) {
			loggerTypeB.error("getCombinedErrorByFilter: Upf List is have null value. Exception");
		}
	    ...
	    switch (type) {
	        case "interface":
	            ...
	            break;}catch (Exception e) {
	            	loggerTypeB.info("Interface : Not enough data to show ");						}
	        ...
	        case "node":
	            ...
	            break;
	        		...
	        		loggerTypeB.info("Node : Not enough data to show ");				}
