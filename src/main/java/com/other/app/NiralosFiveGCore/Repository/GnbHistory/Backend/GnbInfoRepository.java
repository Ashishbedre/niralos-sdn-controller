...
public interface GnbInfoRepository extends MongoRepository<GnbInfoModel, ObjectId> {
	...
	List<GnbInfoModel> findByTenentIdAndSiteId(String tenentId, String siteId);

	List<GnbInfoModel> findByGnbIdAndSiteIdAndTenentId(String gnbId, String siteId, String tenentId, PageRequest of);
