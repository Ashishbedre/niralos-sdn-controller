...
public LiveDataModel(String activeAmfSession, String totalAmfSession, String activeamf, String totalamf,
			String activeUe, String totalUe, String activeUeSession, String totalUeSession, String activeGnb,
			String totalGnb, String activeGnbSession, String totalGnbSession, String nfType, String nfName,
			LocalDateTime localDateTime) {
		super();
		this.activeAmfSession = activeAmfSession;
		this.totalAmfSession = totalAmfSession;
